...
X0=$(( (OUT_W - CONTENT_W) / 2 ))   # 480
Y0=$(( (OUT_H - CONTENT_H) / 2 ))  # 360
# ==============================================

gst-launch-1.0 -v \
    glvideomixer name=mix \
    sink_0::xpos=${X0} sink_0::ypos=${Y0} sink_0::width=1440 sink_0::height=1440 \
    sink_1::xpos=$((X0+1440)) sink_1::ypos=${Y0} sink_1::width=1440 sink_1::height=1440 ! \
